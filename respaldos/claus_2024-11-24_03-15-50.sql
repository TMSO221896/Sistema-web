...
INSERT INTO `bitacora_pasteles` VALUES (5,'Pastel de Vainilla','2024-11-19',100),(6,'Gelatina','2024-11-19',50),(7,'Gelatina','2024-11-19',50),(8,'Gelatina','2024-11-19',50),(9,'Pastel de Vainilla','2024-11-21',100),(10,'Pastel de Fresa','2024-11-21',130),(11,'Cupcake','2024-11-23',400),(12,'Gelatina','2024-11-24',13);
...
INSERT INTO `comentarios` VALUES (22,'Patata','Buenos',0);
...
INSERT INTO `direcciones` VALUES (10,'santiT','BUGAMBILIAS','EMILIANO ZAPATA',6274,226,'MORELOS','CUAUTLA'),(11,'Sebastian','Av insurgentes ','Emiliano zapata',7267,43,'Morelos ','Cuautla');
...
INSERT INTO `pasteles` VALUES (1,'Cupcake','Esquisito cupcake',400,'visualizar'),(2,'Pastel Mediano','Esquisito cupcake personalizado',85,'visualizar'),(3,'Pastel Grande','Esquisito cupcake personalizado con el texto de tu preferecia',150,'visualizar'),(4,'Pastel de Chocolate','Delicioso pastel de chocolate con cobertura suave y relleno cremoso',120,'visualizar'),(5,'Pastel de Fresa','Pastel esponjoso con fresas naturales y crema batida',130,'visualizar'),(6,'Pastel de Vainilla','Pastel cl?sico de vainilla con glaseado de mantequilla',100,'visualizar'),(7,'Pastel de Zanahoria','Pastel de zanahoria con nueces y glaseado de queso crema',10,'visualizar'),(8,'Pastel de Tres Leche','Pastel tradicional de tres leches con un toque de canela',135,'visualizar'),(50,'Gelatina','gelatina roja de muy buen sabor',13,'visualizar');
...
INSERT INTO `pedido_articulos` VALUES (48,41,1,'2024-11-23','rojo','Tqm claudia '),(60,49,50,'2024-11-28',NULL,NULL);
...
INSERT INTO `pedidos` VALUES (41,'Sebastian','2024-11-23','Entregado',40),(49,'admin','2024-11-24','Entregado',13);
...
INSERT INTO `recetas` VALUES (2,'CHOCHOC','AA','admin'),(3,'Flan','AAEE','admin'),(15,'Gelatina','Gelatina','admin');
...
INSERT INTO `resenias` VALUES (19,'santiT',3,'hola'),(25,'santiT',5,'hola'),(28,'santiT',4,'hola');
...
INSERT INTO `usuarios` VALUES ('admin','Admin','Administrador','admin@gmail.com','12345',1,NULL,NULL,NULL,NULL,NULL,NULL),('Alex123','jose','Trejo','Alekei@gmaiil.com','$2y$10$QjS5iUMrLNzvan5CBIi./u0',3,NULL,NULL,NULL,NULL,NULL,NULL),('cinthia123','cinthia','martinez','cinthia.estefania08@gmail.com','123qaz',3,NULL,NULL,NULL,NULL,NULL,NULL),('Gerente2','Santiago','Trejo','Albert@gmail.com','12345',2,NULL,NULL,NULL,NULL,NULL,NULL),('Gerente5','jose','Trejo','Albert@gmail.com','12345',2,NULL,NULL,NULL,NULL,NULL,NULL),('Gerente89','Alekei','Trejo','Albert@gmail.com','12345',2,NULL,NULL,NULL,NULL,NULL,NULL),('Gerente891','popi','Trejo','Albert@gmail.com','12345',2,NULL,NULL,NULL,NULL,NULL,NULL),('JoseJose','santiago','Trejo','tmso221896@upemor.edu.mx','12345',3,NULL,NULL,NULL,NULL,NULL,NULL),('Joselito','Jose','rodriguez','stm123xd@hotmail.com','12345',3,NULL,NULL,NULL,NULL,NULL,NULL),('KeniaLizet','Kenia','Hernandez ','htko220159@upemor.edu.mx','kenia',3,NULL,NULL,NULL,NULL,NULL,NULL),('Patata','Sed','Tm','rata@gmail.com','2010',3,NULL,NULL,NULL,NULL,NULL,NULL),('PepeG','Pepe','Grillo','PepitoGrillo@gmail.com','$2y$10$9bnyaUMFi/HfhYBi63aHWuA',3,NULL,NULL,NULL,NULL,NULL,NULL),('santiT','Santi','Trejo','stm2594xd@gmail.com','12345',3,NULL,NULL,NULL,NULL,NULL,NULL),('Sebastian','Sebastian','Trejo','123trejomario@gmail.com','260967',3,NULL,NULL,NULL,NULL,NULL,NULL),('Zaz','Cacaa','Popo','sebastiantrejo727@gmail.com','uwu',3,NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2024-11-23 20:15:51
