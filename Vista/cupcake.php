...
$pastel_id = 1;  // Este debería venir de algún lugar, como $_GET['id'] o similar
$consulta = "SELECT * FROM pasteles WHERE id_pastel = '$pastel_id'";
$resultado = mysqli_query($conexion, $consulta);
$pastel = mysqli_fetch_array($resultado);
?>
<link rel="stylesheet" href="../Static/css/CupcakeStyle.css" />
<script src="../Static/js/Cupcake.js"></script>
	<body>
		<header>
				...
				<section class="container-info-product">
					...
					<?php (isset($_SESSION['username'])) ?>
						<div class="form-group">
							...
							<input type="hidden" name="id_pastel" value="1" required>
								<!-- Selección de color -->
								...
								<div class="container-text-product">
									<div class="form-group">
										...
										<input type="text" id="inputTexto" name="texto" maxlength="20" placeholder="Escribe aquí..." oninput="actualizarContador()" required>
									</div>
								</div>
