                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="alert alert-info" role="alert">
                                <strong>Aviso:</strong> Aviso: En la sección de creación de productos, es indispensable que el ID del producto sea único. 
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody> <!-- Etiqueta tbody corregida -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label for="lang"><?php echo $Estatus; ?></label>
                                        ...
                                        <body>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php else: ?>
                                                        <!-- Opción para actualizar y eliminar los pasteles a partir del cuarto -->
                                                            <input type="hidden" name="id_pastel" value="<?php echo $id_pastel; ?>">
                                                            <button type="button" class="btn btn-primary btn-sm" onclick="ActualizarProductos(event, <?php echo $id_pastel; ?>)" 
                                                                    data-nombre="<?php echo $nombreP; ?>"
                                                                    data-descripcion="<?php echo $descripcion; ?>"
                            ...
                            <div class="tab-pane fade" id="reportes">
                                ...
                                <!-- Usuarios Nuevos -->
                                <form action="../Static/pdf/generar_reporte.php" method="POST" class="Usuarios_Nuevos" id="Usuarios_Nuevos">
                                    <div class="text-left mt-3">
                                        <label class="form-label">Usuarios Nuevos</label><br>
                                        <button type="submit" name="tipo_reporte" value="usuarios_nuevos" class="btn btn-primary">Crear</button>
                                    </div>
                                </form>

                                <!-- Usuarios Eliminados -->
                                <form action="../Static/pdf/generar_reporte.php" method="POST" class="Usuarios_Eliminados" id="Usuarios_Eliminados">
                                    <div class="text-left mt-3">
                                        <label class="form-label">Usuarios Eliminados</label><br>
                                        <button type="submit" name="tipo_reporte" value="usuarios_eliminados" class="btn btn-primary">Crear</button>
                                    </div>
                                </form>
