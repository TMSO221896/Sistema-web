...
$pastel_id = 2;  // Este debería venir de algún lugar, como $_GET['id'] o similar
$consulta = "SELECT * FROM pasteles WHERE id_pastel = '$pastel_id'";
$resultado = mysqli_query($conexion, $consulta);
$pastel = mysqli_fetch_array($resultado);
?>
<link rel="stylesheet" href="../Static/css/PastelMedianoStyle.css" />
<script src="../Static/js/PastelMediano.js"></script>
				...
				<section class="container-info-product">
					...
					<?php (isset($_SESSION['username'])) ?>
						<div class="form-group">
							...
							<input type="hidden" name="id_pastel" value="2" required>
								<!-- Selección de color -->
								...
								<div class="container-text-product">
									<div class="form-group">
										...
										<input type="text" id="inputTexto" name="texto" maxlength="30" placeholder="Escribe aquí..." oninput="actualizarContador()" required>
									</div>
								</div>
