...
function handleButtonClick2(counter, url, id, descripcion) {
    
    openSweetAlert2(id, descripcion); // Abre SweetAlert con los detalles del pastel
}

// Función que muestra el modal SweetAlert con los detalles dinámicos
function openSweetAlert2(id, descripcion) {
Swal.fire({
    title: 'Receta',
    html: `
